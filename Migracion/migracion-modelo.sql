...
---
CREATE TABLE REYES_DE_DATOS.Producto_categoria (id_producto_categoria INT PRIMARY KEY);
---
CREATE TABLE REYES_DE_DATOS.Producto_subcategoria (id_producto_subcategoria INT PRIMARY KEY);
---
CREATE TABLE REYES_DE_DATOS.Producto_marca (id_producto_marca INT PRIMARY KEY);
---
...
CREATE TABLE REYES_DE_DATOS.Domicilio (
	...
	id_localidad INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Localidad(id_localidad) NOT NULL,
	id_provincia INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Provincia(id_provincia) NOT NULL,
	domicilio_direccion VARCHAR(100) NOT NULL,
);
---
CREATE TABLE REYES_DE_DATOS.Sucursal (
	id_sucursal INT PRIMARY KEY IDENTITY(1,1),
	id_domicilio INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Domicilio(id_domicilio) NOT NULL,
	id_supermercado INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Supermercado(id_supermercado) NOT NULL,
...
CREATE TABLE REYES_DE_DATOS.Cliente(
	...
	cliente_id_domicilio INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Domicilio(id_domicilio) NOT NULL,
	--cliente_id_contacto INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Cliente_Contacto(id_cliente_contacto) NOT NULL,		
...
CREATE TABLE REYES_DE_DATOS.Empleado(
    ...
    id_sucursal INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Sucursal (id_sucursal) NOT NULL,
...
CREATE TABLE REYES_DE_DATOS.Producto (
	...
	id_producto_categoria INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Producto_categoria(id_producto_categoria) NOT NULL,
	id_producto_subcategoria INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Producto_subcategoria(id_producto_subcategoria) NOT NULL,
	id_marca INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Producto_marca(id_producto_marca) NOT NULL,
...
CREATE TABLE REYES_DE_DATOS.Ticket( 
	...
	id_tipo_comprobante INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Tipo_Comprobante (id_tipo_comprobante) NOT NULL,
	id_sucursal INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Sucursal (id_sucursal) NOT NULL,
	id_caja INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Caja (id_caja) NOT NULL,
	id_empleado INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Empleado (id_empleado) NOT NULL,
...
CREATE TABLE REYES_DE_DATOS.Envio(
	...
	id_ticket INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Ticket (id_ticket) NOT NULL,
	id_cliente INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Cliente (id_cliente) NOT NULL,
...
CREATE TABLE REYES_DE_DATOS.Item_Ticket(
	...
	id_ticket INT FOREIGN KEY (id_ticket) REFERENCES REYES_DE_DATOS.Ticket (id_ticket) NOT NULL,
	id_producto INT FOREIGN KEY (id_producto) REFERENCES REYES_DE_DATOS.Producto (id_producto) NOT NULL,
	id_tipo_comprobante INT FOREIGN KEY (id_tipo_comprobante) REFERENCES REYES_DE_DATOS.Tipo_Comprobante (id_tipo_comprobante) NOT NULL,
	id_sucursal INT FOREIGN KEY (id_sucursal)  REFERENCES REYES_DE_DATOS.Sucursal (id_sucursal) NOT NULL,
	id_promocion INT FOREIGN KEY (id_promocion) REFERENCES REYES_DE_DATOS.Promocion (id_promo) NOT NULL,
...
CREATE TABLE REYES_DE_DATOS.Pago(
	...
	id_tipo_medio_de_pago INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Tipo_medio_de_pago(id_tipo_medio_pago) NOT NULL,
	id_cliente INT FOREIGN KEY REFERENCES REYES_DE_DATOS.Cliente(id_cliente) NOT NULL,
	id_descuento INT FOREIGN KEY (id_descuento) REFERENCES REYES_DE_DATOS.Descuento(descuento_codigo),
...
CREATE TABLE REYES_DE_DATOS.Regla_x_Promocion (
	...
	CONSTRAINT FK_Regla_X_Promocion_Promocion FOREIGN KEY (id_promocion) REFERENCES REYES_DE_DATOS.Promocion(id_promo),
	CONSTRAINT FK_Regla_X_Promocion_Regla FOREIGN KEY (id_regla) REFERENCES REYES_DE_DATOS.Regla(id_regla)
);
--
CREATE TABLE REYES_DE_DATOS.Ticket_X_Pago(
	...
	CONSTRAINT FK_Ticket_X_Pago_id_ticket FOREIGN KEY (id_ticket) REFERENCES REYES_DE_DATOS.Ticket (id_ticket),
	CONSTRAINT FK_Ticket_X_Pago_id_pago FOREIGN KEY (id_pago) REFERENCES REYES_DE_DATOS.Sucursal (id_sucursal)
);
--
CREATE TABLE REYES_DE_DATOS.Promocion_X_Item_Ticket (--
	...
	CONSTRAINT FK_Promocion_X_ItemTicket_Promocion FOREIGN KEY (id_promocion) REFERENCES REYES_DE_DATOS.Promocion(id_promo),
	CONSTRAINT FK_Promocion_X_ItemTicket_Item_Ticket FOREIGN KEY (id_item_ticket) REFERENCES REYES_DE_DATOS.Item_Ticket(id_item_ticket)
);
--
CREATE TABLE REYES_DE_DATOS.Promocion_X_Producto (
	...
	CONSTRAINT FK_Promoxion_X_Producto_id_promocion FOREIGN KEY (id_promocion) REFERENCES REYES_DE_DATOS.Promocion(id_promo),
	CONSTRAINT FK_Promoxion_X_Producto_id_producto FOREIGN KEY (id_producto) REFERENCES REYES_DE_DATOS.Producto(id_producto)
);
GO
------------------------------------------------------------------------------------------------
----- FUNCIONES PARA USAR -----
...
AS
BEGIN
	INSERT INTO REYES_DE_DATOS.Producto_categoria(id_producto_categoria)
...
AS
BEGIN
	INSERT INTO REYES_DE_DATOS.Producto_subcategoria(id_producto_subcategoria)
...
AS
BEGIN
	INSERT INTO REYES_DE_DATOS.Producto_marca(id_producto_marca)
...
BEGIN
	INSERT INTO REYES_DE_DATOS.Caja(
      ...
      SELECT --select * from gd_esquema.Maestra
        ...
        c.id_tipo_caja
      FROM gd_esquema.Maestra m
	  JOIN REYES_DE_DATOS.Tipo_Caja c ON 
...
BEGIN
    ...
    SELECT
        m.SUPER_DOMICILIO,
        REYES_DE_DATOS.get_localidad_id(m.SUPER_DOMICILIO) AS id_localidad,
        REYES_DE_DATOS.get_provincia_id(m.SUPER_PROVINCIA) AS id_provincia
    FROM gd_esquema.Maestra m
    ...
    SELECT
        m.CLIENTE_DOMICILIO,
        REYES_DE_DATOS.get_localidad_id(m.CLIENTE_LOCALIDAD),
        REYES_DE_DATOS.get_provincia_id(m.CLIENTE_PROVINCIA)
    FROM gd_esquema.Maestra m
...
BEGIN
	...
	SELECT
		REYES_DE_DATOS.get_domicilio_id(m.SUPER_DOMICILIO),
		s.id_supermercado,
...
BEGIN
	...
	SELECT DISTINCT
		m.CLIENTE_DNI,
		REYES_DE_DATOS.get_domicilio_id(m.CLIENTE_DOMICILIO),
		m.CLIENTE_NOMBRE,
		m.CLIENTE_APELLIDO,
...
BEGIN
	...
	SELECT 
		REYES_DE_DATOS.get_sucursal_id(m.SUCURSAL_DIRECCION),
		m.EMPLEADO_NOMBRE,
		m.EMPLEADO_APELLIDO,
		m.EMPLEADO_DNI,
...
BEGIN
	...
	SELECT DISTINCT
        ...
        REYES_DE_DATOS.get_sucursal_id(m.SUCURSAL_DIRECCION),
        caja.id_caja,
        REYES_DE_DATOS.get_empleado_id(m.EMPLEADO_MAIL),
        m.TICKET_FECHA_HORA,
...
BEGIN
	...
	SELECT 
        m.TICKET_NUMERO,
        REYES_DE_DATOS.get_cliente_id(m.CLIENTE_DNI),
...
BEGIN
	...
	SELECT 
		m.PROMO_CODIGO,
		REYES_DE_DATOS.get_regla_id(m.REGLA_DESCRIPCION)
	FROM gd_esquema.Maestra m
	WHERE 
...
BEGIN
	...
	SELECT
		...
		p.id_pago
	FROM gd_esquema.Maestra m
		JOIN REYES_DE_DATOS.Pago p ON --No creo que un mismo cliente pueda hacer 2 pagos en el MISMO SEGUNDO
			m.REYES_DE_DATOS.get_cliente_id(m.CLIENTE_DNI) = p.id_cliente 
